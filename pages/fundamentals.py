...
with st.expander("Guideline on the WWFT and SW"):
    st.pdf("C:/Users/dwiedenhof/Documents/streamlit_template/Streamlit template/pdfs/leidraad-wwft-sw-eng.pdf", height=850)
...
with st.expander("From recovery to balance"):
    st.pdf("C:/Users/dwiedenhof/Documents/streamlit_template/Streamlit template/pdfs/from-recovery-to-balance.pdf", height=580)
